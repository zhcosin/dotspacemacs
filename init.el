...
It should only modify the values of Spacemacs settings."
  ...
  (setq-default
   ...
   ;; per project or `(recents-by-project . nil)'.
   ...
   ;; a non-negative integer, optionally followed by the unit `pt'.
   ;; (default 10.0)
   ...
   ;; paste something, pressing `C-j' and `C-k' will cycle through the elements
   ;; in the `kill-ring'. (default nil)
   ...
   ;; If non-nil the frame is undecorated when Emacs starts up. Only for GUI.
   ;; (default nil)
